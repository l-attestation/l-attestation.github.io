...
## Classement du 1er mars au 1er juin

```{r summarise_spring}
excess_mortality_spring = summarise_excess_mortality(ymd(20200101), ymd(20200601))
```
...
```{r summarise_2020}
excess_mortality_2020 = summarise_excess_mortality(ymd(20200101), ymd(20201231))
```
