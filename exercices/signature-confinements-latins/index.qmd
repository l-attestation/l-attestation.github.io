...
categories: [FAQ]
citation: 
  url: https://l-attestation.github.io/signature-confinements-latins/
...
La manière la plus simple de récupérer les données de mobilité est de passer par le package {tidycovid19}, qui peut être installé ainsi :
