...
Ce site présente l'enquête, ses sources, ses méthodes et le [**code informatique**](https://l-attestation.github.io/exercices.html) des analyses statistiques. Une sélection de courtes vidéos permet de retrouver l'atmosphère de la période. Voir également le [**diaporama**](diaporama.qmd) correspondant à la présentation la plus récente du livre.
